...
ostream &operator<< (ostream &strm, std::moneypunct<char>::pattern p)
{
...
int main(int argc, const char *argv[])
{
    try
    {
        ...
        cout << endl;
        printMoneyPunct<false>("en_US.utf8");
        cout << endl;
        printMoneyPunct<true>("en_US.utf8");
        cout << endl;
        printMoneyPunct<false>("zh_CN.utf8");
        cout << endl;
        printMoneyPunct<true>("zh_CN.utf8");
        cout << endl;
        printMoneyPunct<false>("de_DE.utf8");
        cout << endl;
        printMoneyPunct<true>("de_DE.utf8");
        cout << endl;
